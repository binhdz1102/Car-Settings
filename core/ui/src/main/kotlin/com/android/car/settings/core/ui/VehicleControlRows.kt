...
fun VehicleSwitchRow(
    ...
    val annotation =
        stableVehicleControlAnnotation(
            ...
            unavailableDescription = stringResource(R.string.vehicle_control_unavailable),
        )
        ...
        if (readOnly) {
            ...
            Modifier
                .toggleable(
                    ...
                    stateDescription = stableVehicleValueStateDescription(valueDescription)
                }
        }
    ...
    Column(
        modifier =
            modifier
                ...
                .semantics {
                    stateDescription = stableVehicleValueStateDescription(valueLabel)
...
fun VehicleEnumRow(
    ...
    val annotation =
        stableVehicleControlAnnotation(
            ...
            disabledReason = disabledReason,
            readOnlyDescription = readOnlyDescription,
            unavailableDescription = unavailableLabel,
        )
            ...
            if (readOnly) {
                ...
                Modifier
                    .clickable(
                        ...
                        stateDescription = stableVehicleValueStateDescription(selectedDescription)
                    }
            }
        BListItem(
            headline = title,
                ...
                .semantics {
                    stateDescription =
                        when {
                            ...
                            else -> stableVehicleValueStateDescription(statusDescription)
                        }
