...
internal fun VehicleFeatureOverview(
    ...
    VehicleSettingsScaffold(
        ...
        onBack = onBack,
        destinationKey = "vehicle-overview-$areaId",
        modifier = modifier,
        ...
        contentFocusAreaId = contentFocusAreaId,
        actions = {
...
private fun VehicleShowAllCard(
    ...
    FocusItem(
        ...
        BCard(
            ...
            size = BCardSize.Lg,
            selected = state.isFocused && !LocalIsInTouchMode.current,
            onClick = onClick,
            content = {
                Row(
...
private fun VehicleCategoryCard(
    ...
    FocusItem(
        ...
        SettingsCardSurface(
            ...
            focused = state.isFocused && !LocalIsInTouchMode.current,
            selected = state.isFocused && !LocalIsInTouchMode.current,
        ) {
            Row(
...
internal fun VehicleCategoryScreen(
    ...
    VehicleSettingsScaffold(
        ...
        contentFocusAreaId = controlsAreaId,
        actions = {
            SettingsAppBarAction(
            ...
            if (wideLayout) {
                Row(
                    ...
                    VehiclePreviewPane(
                        ...
                        nextAreaId =
                            if (selectableZones.size > 1) zoneAreaId else controlsAreaId,
                ...
                Column(
                    modifier =
                        Modifier
                            .fillMaxSize()
                            .vehicleBScrollbar(overviewScrollState)
