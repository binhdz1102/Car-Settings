...
internal class WifiRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun setCellularFallbackEnabled(enabled: Boolean) = platform.setCellularFallbackEnabled(enabled)

        override suspend fun setPersistentTetheringEnabled(enabled: Boolean) = platform.setPersistentTetheringEnabled(enabled)

        override suspend fun setMobileDataEnabled(enabled: Boolean) = platform.setMobileDataEnabled(enabled)

        override suspend fun setDataRoamingEnabled(enabled: Boolean) = platform.setDataRoamingEnabled(enabled)

        override suspend fun setDefaultDataSubscription(subscriptionId: Int) = platform.setDefaultDataSubscription(subscriptionId)
    }
