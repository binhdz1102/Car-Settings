...
internal interface SystemPlatform {
    ...
    suspend fun setKeyboardEnabled(id: String, enabled: Boolean): ActionResult

    suspend fun setTextToSpeechEngine(packageName: String): ActionResult

    suspend fun setTextToSpeechPlayback(speechRate: Int, pitch: Int): ActionResult

    suspend fun speakTextToSpeechSample(): ActionResult

    suspend fun setVehicleUnit(propertyId: Int, unitId: Int): ActionResult

    suspend fun launchExternal(actionId: SystemExternalActionId): ActionResult

    suspend fun restartSystem(): ActionResult

    suspend fun resetNetwork(subscriptionId: Int?, eraseEsim: Boolean): ActionResult
