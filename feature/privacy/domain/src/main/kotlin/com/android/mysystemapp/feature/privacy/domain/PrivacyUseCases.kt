...
class PrivacyUseCases @Inject constructor(private val repository: PrivacyRepository) {
    ...
    suspend fun setAppPermission(packageName: String, type: PrivacyPermissionType, granted: Boolean) =
