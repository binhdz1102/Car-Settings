...
@Singleton
internal class PrivacyRepositoryImpl @Inject constructor(
    ...
    override suspend fun setAppPermission(packageName: String, type: PrivacyPermissionType, granted: Boolean) =
