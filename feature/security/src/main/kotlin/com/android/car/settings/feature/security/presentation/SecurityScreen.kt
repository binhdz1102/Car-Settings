...
fun SecurityRoute(
    ...
    SettingsScaffold(
        ...
        isRoot = true,
        onBack = onBack,
        // On a stock AVD the app is not the Settings role, so screen-lock and credential
        // management are intentionally disabled.  Park CCP on the first meaningful action
        // instead of handing B-Material a disabled FocusItem as the initial target.
        firstContentFocusId =
            if (uiState.security.canManageScreenLock && !uiState.security.isGuestUser) {
