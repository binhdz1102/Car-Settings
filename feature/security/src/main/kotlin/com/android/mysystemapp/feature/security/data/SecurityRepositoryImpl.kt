...
@Singleton
internal class SecurityRepositoryImpl @Inject constructor(private val platform: SecurityPlatform) : SecurityRepository {
    override val state = platform.state
    override suspend fun refresh() = platform.refresh()
    override suspend fun setLock(type: SecurityLockType, currentCredential: String, newCredential: String) =
