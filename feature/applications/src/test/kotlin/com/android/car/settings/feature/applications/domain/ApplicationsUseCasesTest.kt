...
private class RecordingApplicationsRepository : ApplicationsRepository {
    ...
    override val permissionGroups = MutableStateFlow<List<PermissionGroupSummary>>(emptyList())
    override val permissionApps = MutableStateFlow<List<ApplicationSummary>>(emptyList())
    override val selectedAppPermissions = MutableStateFlow<List<AppPermissionState>>(emptyList())
    override val defaultAppRoles = MutableStateFlow<List<DefaultAppRole>>(emptyList())
    override val openingLinks = MutableStateFlow<List<OpeningLinkState>>(emptyList())
