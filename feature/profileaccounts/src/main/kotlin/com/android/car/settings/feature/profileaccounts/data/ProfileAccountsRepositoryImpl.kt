...
@Singleton
internal class ProfileAccountsRepositoryImpl
    @Inject
    constructor(
        ...
        override suspend fun logoutCurrentUser() = platform.logoutCurrentUser()
        ...
        override suspend fun selectAccount(
            name: String,
            type: String,
        ) = platform.selectAccount(name, type)
        ...
        override suspend fun addAccount(providerType: String): AddAccountResult = platform.addAccount(providerType)
    }
