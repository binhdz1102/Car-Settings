...
class ProfileAccountsUseCases @Inject constructor(
    ...
    suspend fun selectAccount(name: String, type: String) = repository.selectAccount(name, type)
    suspend fun clearSelectedAccount() = repository.clearSelectedAccount()
    suspend fun setAccountSyncEnabled(authority: String, enabled: Boolean) =
